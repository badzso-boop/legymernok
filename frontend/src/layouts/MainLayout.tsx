...
const MainLayout: React.FC = () => {
    ...
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', minWidth: '100vh' }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1 }}>
                        ...
                        {!isAuthenticated ? (
                            <>
                                ...
                                <Button variant="contained" color="primary" onClick={() => navigate('/register')}>{t('register')}</Button>
                            </>
                        ) : (
                            <>
                                {hasRole('ROLE_ADMIN') && (
